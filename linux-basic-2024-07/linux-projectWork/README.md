...
## I. Инфраструктура приложения
![Инфраструктура приложения](./readme-data/nodeScheme.png)

## II. Предусловия для аварийного восстановления
* Установлен docker

* Есть сетевой доступ к Docker hub (для возможности скачивания docker-образов)
